...
SI_IJAWH_WRITREWARD1			= "for the delivery of crafted goods",
...
SI_IJAWH_SAVEDALCHEMY_CONFIRMDELETE_TITLE = "Delete selected Recipe",
SI_IJAWH_SAVEDALCHEMY_CONFIRMDELETE_TEXT = "Do you want to delete <<1>> from the saved recipes?",
SI_IJAWH_INVALIDRECIPE = "Invalid recipe",
