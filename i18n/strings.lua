...
SI_IJAWH_CHATTEROPTION10		= "Sign the Manifest"
SI_IJAWH_CHATTEROPTION11 		= "finished the job"

SI_IJAWH_WRITREWARD1			= "A reward for the delivery of crafted goods"
SI_IJAWH_WRITREWARD2			= "A shipment of raw materials"

SI_IJAWH_BUTTON_RESETWRIT = "Reset For Writ"

SI_IJAWH_WRIT = "Writ"
SI_IJAWH_SIGN = "Sign"
SI_IJAWH_JOB = "finished the job"
SI_IJAWH_GOODS = "Place the goods within the crate"
...
SI_IJAWH_TOTAL_WRITS = "Completed Writs: <<1>>/<<2>>"
...
-- Dialogues
------------------------------------------------
SI_IJAWH_TUTORIAL_CRAFT_WRIT_TITLE = zo_strformat("|c00FF00<<1>>|r",GetString(SI_IJAWH_CRAFT_WRIT)) .. "  button"
SI_IJAWH_TUTORIAL_CRAFT_WRIT_TEXT = "The " .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_IJAWH_CRAFT_WRIT)) .. " button is enabled when all crafting parameters are met.\nIn order to craft other times, you must first meet the writ conditions by crafting or acquiring the needed items.\n\nYou can disable this feature by unchecking " .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_IJAWH_SETTING_SHOWCRAFTFORWRIT)) .. " in the settings."

SI_IJAWH_TUTORIAL_ALCHEMY_TITLE = "Alchemy Recipes"
SI_IJAWH_TUTORIAL_ALCHEMY_TEXT = "Many alchemy results have more than one recipe that can create it.\nThose recipes can be selected by using the arrows on the sides of the info box.\nThe selected reagents will change to the ones for the currently selected recipe.\n\nAlchemy recipes are sorted by the reagents used to make it.\n1: By stock on hand. (if " .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_LIBIJA_REAGENT_PRIORITY_BY_STOCK)) .. " is checked in the settings.)\n2: By manually selected order. (set in a list in the settings if " .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_LIBIJA_REAGENT_PRIORITY_BY_MANUAL)) .. " is checked in the settings.)\n3: By Tamriel Trade Centre lowest average price. (if " .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_LIBIJA_REAGENT_PRIORITY_BY_PRICE1)) .. " is checked in the settings)\nThe sort mode is selected in the settings.\n\n" .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_LIBIJA_TTC_INSTALL))

SI_IJAWH_TUTORIAL_STYLEMATERIALS_TITLE = "Style Material"
SI_IJAWH_TUTORIAL_STYLEMATERIALS_TEXT = "The default style material used in smithing auto-crafting with \"Craft For Writ\", is the style material you have the most of.\nDisabled: \"Craft For Writ\" will use the style material you select.\n\nYou can disable this feature by unchecking " .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_IJAWH_SETTING_USEMOSTSTYLE)) .. " in the settings."

SI_IJAWH_TUTORIAL_WITHDRAW_TITLE = "Have an item that needs to be crafted already in the bank?"
SI_IJAWH_TUTORIAL_WITHDRAW_TEXT = "If you already have an item in the bank that the writ requires, you will receive an alert and that item will be added to a list to be auto-withdrawn the next time you access the bank.\nThe \"withdraw list\" will add items from all crafting stations you access so you can withdraw them all in one stop.\n\nYou can disable this feature by unchecking " .. zo_strformat("|c00FF00<<1>>|r",GetString(SI_IJAWH_SETTING_HANDLEWITHDRAW)) .. " in the settings."
    

/script SetCVar("language.2", "en")
SI_IJAWH_CHATTEROPTION2			= "I've got them right here"
SI_IJAWH_NOTENOUGH              = "You do not have enough <<1>>."

/script SetCVar("language.2", "de")
SI_IJAWH_CHATTEROPTION2			= "Ich habe sie." -- "I've got them right here"
SI_IJAWH_NOTENOUGH              = "Ihr habt nicht genügend <<1>>." --  "You do not have enough
/script SetCVar("language.2", "fr")
SI_IJAWH_CHATTEROPTION2			= "J'en ai sur moi." -- "I've got them right here"
SI_IJAWH_NOTENOUGH              = "Vous n'avez pas assez <<1>>." --  "You do not have enough
/script SetCVar("language.2", "ru")
SI_IJAWH_CHATTEROPTION2			= "У меня есть все, что нужно."  -- "I've got them right here"
SI_IJAWH_NOTENOUGH              = "Недостаточно <<1>>." --  "You do not have enough



/script d(GetString(SI_RESPECRESULT29))

SI_IJAWH_CHATTEROPTION11		= "Blacksmith writ"
SI_IJAWH_CHATTEROPTION12		= "Clothier writ"
SI_IJAWH_CHATTEROPTION13		= "Enchanter Writ"
SI_IJAWH_CHATTEROPTION14		= "Alchemist Writ"
SI_IJAWH_CHATTEROPTION15		= "Provisioner Writ"
SI_IJAWH_CHATTEROPTION16		= "Woodworker writ"
SI_IJAWH_CHATTEROPTION17		= "Jewelry Crafting Writ"



IJAWH_WRITCRATE_CLOTHIER		= "Clothiers Satchel.*"
IJAWH_WRITCRATE_WOODWORKER		= "Woodworkers Case.*"
IJAWH_WRITCRATE_BLACKSMITH		= "Blacksmiths Crate.*"
IJAWH_WRITCRATE_JEWELRY			= "Jewelry Crafters Coffer.*"
IJAWH_WRITCRATE_ENCHANTER		= "Enchanters Coffer.*"
IJAWH_WRITCRATE_PROVISIONER		= "Provisioners Pack.*"
IJAWH_WRITCRATE_ALCHEMIST		= "Alchemists Vessel.*"
IJAWH_WRITSHIPMENT 				= "Shipment of.*"
