------------------------------------------------
-- German localization for IsJustaWritHelper
------------------------------------------------
local strings = {
...
SI_IJAWH_WRITREWARD1			= "für die lieferung hergestellter waren", -- "for the delivery of crafted goods",
SI_IJAWH_WRITREWARD2			= "eine lieferung rohmaterial", -- "A shipment of raw materials"
...
SI_IJAWH_TOTAL_WRITS = "Abgeschlossene bestellungen: <<1>>/<<2>>", -- "Completed Writs: <<1>>/<<2>>"
